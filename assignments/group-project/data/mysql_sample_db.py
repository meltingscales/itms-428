...
class ProductLinesData(GenericData):
  ...
  PRIMARY KEY (`productLine`)
    ...
    insert_statements = f"""insert  into `{table_name}`(`productLine`,`textDescription`,`htmlDescription`,`image`) values 
...
class EmployeeData(GenericData):
    ...
    CREATE TABLE `{table_name}` (
        ...
        CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `{table_name}` (`employeeNumber`),
CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`)
  )"""
    insert_statements = f"""INSERT INTO `{table_name}`(`employeeNumber`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) values 
...
class CustomerData(GenericData):
    ...
    table_def = f"""CREATE TABLE `{table_name}` (
        ...
        CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `{EmployeeData.table_name}` (`employeeNumber`)
        )
    """
    insert_statements = f"""INSERT INTO `{table_name}`(`customerNumber`,`customerName`,`contactLastName`,`contactFirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`salesRepEmployeeNumber`,`creditLimit`)
    VALUES 
...
class PaymentsData(GenericData):
  ...
  CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `{CustomerData.table_name}` (`customerNumber`)
);"""
    insert_statements = f"""insert  into `{table_name}`(`customerNumber`,`checkNumber`,`paymentDate`,`amount`) values 
...
class OfficesData(GenericData):
    ...
    insert_statements = f"""insert  into `{table_name}`(`officeCode`,`city`,`phone`,`addressLine1`,`addressLine2`,`state`,`country`,`postalCode`,`territory`) values 
...
class OrdersData(GenericData):
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `{CustomerData.table_name}` (`customerNumber`)
);"""
    insert_statements = f"""insert  into `{table_name}`(`orderNumber`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`customerNumber`) values 
...
class OrderDetailsData(GenericData):
  ...
  CONSTRAINT `orderdetails_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `{OrdersData.table_name}` (`orderNumber`),
  CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`productCode`) REFERENCES `{ProductsData.table_name}` (`productCode`)
);"""
    insert_statements = f"""insert  into `{table_name}`(`orderNumber`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
